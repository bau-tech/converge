...
export const RUNTIME_CONFIG = {
    ...
    DEMO_LOGIN_EMAIL: pick('DEMO_LOGIN_EMAIL', 'VITE_DEMO_LOGIN_EMAIL', ''),
    ...
    OLLAMA_API_KEY: pick('OLLAMA_API_KEY', 'VITE_OLLAMA_API_KEY', ''),
    COLLABORA_ENABLED: pick('COLLABORA_ENABLED', 'VITE_COLLABORA_ENABLED', '') === 'true',
}
